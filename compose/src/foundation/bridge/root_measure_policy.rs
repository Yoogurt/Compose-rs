    ...
    Box::new(|measure_scope: &mut dyn MeasureScope, measurables: &mut [&mut dyn Measurable], constraint: &Constraint| -> MeasureResult {
        match measurables.len() {
            ...
            1 => {
                ...
                measure_scope.layout(placeable.get_width(), placeable.get_height(), &mut |place_scope| {
            ...
            _ => {
                ...
                let mut placeables = measurables.into_iter().map(|measurable| {
                ...
                measure_scope.layout(constraint.constrain_width(max_width),
